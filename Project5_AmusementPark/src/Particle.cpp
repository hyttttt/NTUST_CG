// refer to: https://blog.csdn.net/ZJU_fish1996/article/details/51968085
#include<stdlib.h>
#include"particle.h"
...
void particle::draw()
{
	const GLfloat x1 = -1, x2 = 1;
	const GLfloat y1 = -1, y2 = 1;
	const GLfloat z = -200;
	const GLfloat point[4][3] = { { x1, y1, z },{ x2, y1, z },{ x2, y2, z },{ x1, y2, z } };
	glBegin(GL_QUADS);
	for (int i = 0; i < 4; i++) {
		glVertex3fv(point[i]);
	}
